...
router.post 		('/teams/in_game/:game_id' 		,teamController.viewTeamsInGame);
...
router.put      ('/teams/:team_id/teampic', uploadController.upload.single('teampic') ,teamController.updateTeamPicture);
